...
class GetValuePixels(object):
    ...
    def getValues(self, printStatus):
        def getValuePixel(geomPoint, srPoint, pathImage, nBand):
            ...
            def getValue(band, transfInv, x, y):
                def pt2fmt(pt):
            ...
            transfInv = gdal.InvGeoTransform( ds.GetGeoTransform() )
            ( x, y ) = getXYGeom( ds )

            return getValue( band, transfInv, x, y )
