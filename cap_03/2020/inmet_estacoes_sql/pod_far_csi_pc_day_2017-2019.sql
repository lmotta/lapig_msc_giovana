SELECT
	CAST(n11 AS REAL) / (n11+n10) * 100 AS POD,
	CAST(n01 AS REAL) / (n11+n01) * 100 AS FAR,
	CAST(n11 AS REAL) / (n11+n01+n10) * 100 AS CSI,
	CAST((n11+n00) AS REAL) / (n00+n11+n01+n10) * 100 AS PC
FROM
(
SELECT
